...
pipeline {
    ...
    stages {
        ...
        stage('Git: Code Checkout') {
            steps {
                script{
                    code_checkout("https://github.com/parthkale3231/Wanderlust-Mega-Project.git","main")
                }
            }
        }
        ...
        stage("SonarQube: Code Analysis"){
            steps{
                script{
                    sonarqube_analysis("sonar token","wanderlust","wanderlust")
                }
            }
        }
